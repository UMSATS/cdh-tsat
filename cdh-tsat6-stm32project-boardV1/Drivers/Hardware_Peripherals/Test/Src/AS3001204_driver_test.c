...
HAL_StatusTypeDef AS3001204_Test_Read_ID_Registers() {
    ...
    //NOTE: THE UNIQUE ID IS SET TO THE MRAM ON THE FLIGHT MODEL
    //      RUNNING THIS TEST ON THE ENGINEERING MODEL WILL FAIL, SINCE THE UNIQUE ID WILL BE DIFFERENT
    const uint8_t UNIQUE_ID[AS3001204_UNIQUE_ID_LENGTH] = {0x9d, 0x00, 0x02, 0x24, 0x0e, 0x01, 0x00, 0x14};
