...
#define AS3001204_SPI 			hspi3
#define AS3001204_SPI_DELAY 	HAL_MAX_DELAY

#define AS3001204_nCS_GPIO 		GPIOD
#define AS3001204_nCS_PIN 		GPIO_PIN_2

#define AS3001204_nWP_GPIO 		GPIOA
#define AS3001204_nWP_PIN 		GPIO_PIN_15
