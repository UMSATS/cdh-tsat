...
HAL_StatusTypeDef AS3001204_Test_Read_ID_Registers() {
    ...
    //NOTE: THE UNIQUE ID IS SET TO THE MRAM ON A SPECIFIC BREAKOUT BOARD IN THE LAB
    //      RUNNING THIS TEST WITH ANY OTHER MRAM CHIP WILL FAIL, SINCE THE UNIQUE ID WILL BE DIFFERENT
